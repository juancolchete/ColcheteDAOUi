                  	...
                  	c-11.4,0-20.6-9.2-20.6-20.6c0-11.4,9.2-20.6,20.6-20.6h21.2c11.4,0,20.6,9.2,20.6,20.6C353.3,177.9,344.1,187.1,332.8,187.1z" />
                  		...
                  		C445.1,269.6,446.4,268.3,448.1,268.3z" />
                            ...
                            <div className="error-content">
                                ...
                                <p>We are Really Sorry But the Page you Requested is Missing <i className="icofont-worried" /></p>
                                <a href="index.html" className="default-btn move-left"><span>Go Back to Home</span> </a>
                            </div>
                        </div>
                    </div>
                </div>
...
export default Colchete404Content;
